...
class AutenticazioneDAOTests(unittest.TestCase):
    ...
    def test_trovaUtenteByEmail_pass(self):
        ...
        self.assertEqual(dipendenteResult.nome, self.dipendenteExpected.nome)
        self.assertEqual(dipendenteResult.cognome, self.dipendenteExpected.cognome)
        self.assertEqual(dipendenteResult.email, self.dipendenteExpected.email)
        self.assertEqual(dipendenteResult.password, self.dipendenteExpected.password)
        self.assertEqual(dipendenteResult.ruolo, self.dipendenteExpected.ruolo)
        self.assertEqual(dipendenteResult.dataNascita, self.dipendenteExpected.dataNascita)
        self.assertEqual(dipendenteResult.codice, self.dipendenteExpected.codice)
